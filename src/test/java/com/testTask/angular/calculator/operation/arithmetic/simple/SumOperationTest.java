...
public class SumOperationTest {
    ...
    private SumOperation operationForTest;

    private static final Double DEFAULT_FIRST_ARGUMENT = 10D;
    private static final Double DEFAULT_SECOND_ARGUMENT = 5D;
    private static final Integer DEFAULT_RESULT = 15;

    @Before
    public void initTest(){
        operationForTest = new SumOperation();
    }
    ...
    public void testWhenFirstArgumentNull() throws ServiceException {
        ...
        assertEquals(DEFAULT_SECOND_ARGUMENT.intValue(), result.intValue());
    }
